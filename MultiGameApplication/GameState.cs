...
namespace MultiGameApplication
{
    ...
    {
        public int AmountGamesPlayed = Int32.Parse( File.ReadAllText("TicTacToeScoreboard.txt"));
        ...
        private bool DidMoveWin(int r, int c, out WinInfo winInfo)
        {
            ...
            (int, int)[] mainDiagnol = new[] { (0, 0), (1, 1), (2, 2) };

            (int, int)[] antiDiagnol = new[] { (0, 2), (1, 1), (2, 0) };
            ...
            if (AreSquaresMarked(mainDiagnol, CurrentPlayer))
            {
                winInfo = new WinInfo { Type = WinType.MainDiagnol};
                return true;
            }
            if (AreSquaresMarked(antiDiagnol, CurrentPlayer))
            {
                winInfo = new WinInfo { Type = WinType.AntiDiagnol };
                return true;
            }
